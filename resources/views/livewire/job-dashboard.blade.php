    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-md transition duration-300">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                @if($job->image)
                <img src="{{ asset('storage/' . $job->image) }}" class="w-full h-48 object-cover rounded-t-2xl">
                @else
                <img src="{{ asset('images/default-job.jpg') }}" class="w-full h-48 object-cover rounded-t-2xl">
                @endif
                <div class="flex-1">
